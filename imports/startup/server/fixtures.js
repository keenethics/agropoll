...
Meteor.startup(() => {
  ...
  Clusters.remove({});
  const clusters = [
    { conditions: '{ "type": "company", "farmlandArea": { "$lt": 100 } }', farmersCount: 1000 },
    { conditions: '{ "type": "company", "farmlandArea": { "$gte": 100 } }', farmersCount: 10 },
    { conditions: '{ "type": "personal" }', totalArea: 10000 },
  ];
